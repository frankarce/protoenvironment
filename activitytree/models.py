...
class LearningStyleInventory(models.Model):
    ...
    aca_lvl = models.PositiveSmallIntegerField()
...
#para guardar los datos generados por el kinect
class UserAffectiveData(models.Model):
    user = models.TextField(blank=True)
    activity = models.TextField(blank=True)
    engage_count = models.TextField(blank=True)
    happy_count = models.TextField(blank=True)
    away_count = models.TextField(blank=True)
